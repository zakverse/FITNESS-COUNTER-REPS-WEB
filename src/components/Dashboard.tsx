    ...
    <main className="flex-grow p-6 md:p-8 max-w-7xl w-full mx-auto space-y-8 animate-[fadeIn_0.4s_ease-out]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 flex flex-col justify-center space-y-3">
          <h1 className="text-3xl md:text-5xl font-black italic tracking-tighter uppercase leading-none">
            JELAJAHI <span className="text-red-500 bg-gradient-to-r from-red-500 to-rose-500 bg-clip-text text-transparent">BATAS KEMAMPUAN</span> ANDA
          </h1>
        ...
        <div className="glass-panel rounded-2xl p-6 glow-red border border-red-500/20 relative overflow-hidden flex flex-col justify-between">
          <div className="absolute top-0 right-0 w-24 h-24 bg-red-500/5 rounded-full blur-2xl"></div>
          <h2 className="text-xs uppercase tracking-widest text-red-400 font-bold mb-4 flex items-center justify-between">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="pl-2">
              ...
              <span className="text-3xl font-black italic tracking-tighter text-red-500 block mt-1">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6">
          {Object.entries(EXERCISES_DATA).map(([key, item]) => {
            ...
            if (key === "jj") {
              iconSvg = (
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-rose-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              iconSvg = (
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-red-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-0 left-0 w-2 h-full bg-gradient-to-b from-transparent via-red-500/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300"></div>

                <div className="space-y-4">
                  {/* Icon & Muscle Group Badge */}
                  <div className="flex justify-between items-start">
                    <div className="p-3 bg-white/5 rounded-xl group-hover:bg-red-500/10 group-hover:text-red-400 transition-colors duration-300">
                      {iconSvg}
                    </div>
                  ...
                  <div className="space-y-1">
                    <h4 className="text-lg font-bold group-hover:text-red-400 transition-colors duration-300 tracking-tight">
                      {item.name}
                    </h4>
                ...
                <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                  <div className="flex flex-col">
                    ...
                    <span className="text-2xl font-black italic tracking-tighter text-white tabular-nums group-hover:text-red-400 transition-colors duration-300">
                      {repsCount}
                    </span>
                  </div>
                  ...
                  <Link
                    to={routePath}
                    className="p-2.5 rounded-xl bg-white/5 border border-white/10 group-hover:bg-red-600 group-hover:border-red-600 group-hover:text-white transition-all duration-300 text-slate-300 flex items-center justify-center cursor-pointer shadow-md"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel rounded-2xl p-6 border-white/5 space-y-4">
          <h3 className="text-xs uppercase tracking-widest text-red-400 font-bold font-mono">
            PANDUAN PENYETELAN KAMERA
          </h3>
          
          <ul className="space-y-3 text-xs text-slate-400">
            <li className="flex items-start gap-3">
              <span className="w-5 h-5 rounded-full bg-white/5 border border-white/10 flex items-center justify-center font-mono font-bold text-red-400 flex-shrink-0 text-[10px]">
                1
              </span>
          ...
          <div className="flex-grow overflow-y-auto max-h-48 pr-2 space-y-2.5">
            {logs.length === 0 ? (
              ...
              logs.map((log) => (
                <div
                  key={log.id}
                  className="bg-zinc-950/40 border border-white/5 px-4 py-2.5 rounded-xl flex justify-between items-center text-xs hover:border-red-500/20 hover:bg-zinc-950/70 transition-all duration-150"
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono font-black bg-red-500/10 text-red-400 px-3 py-1 rounded-md border border-red-500/20 shadow-sm">
                      {log.count}
                    </span>
                  </div>
                </div>
